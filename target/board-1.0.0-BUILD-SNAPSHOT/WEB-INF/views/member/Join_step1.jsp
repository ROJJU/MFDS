...
2.	2.타인의 정보도용
3.	3."회사"가 게시한 정보의 변경
4.	4."회사"가 정한 정보 이외의 정보(컴퓨터 프로그램 등) 등의 송신 또는 게시
5.	5."회사"와 기타 제3자의 저작권 등 지적재산권에 대한 침해
6.	6."회사" 및 기타 제3자의 명예를 손상시키거나 업무를 방해하는 행위
...
4.	4.메일서비스
5.	5.보안패치, 백신서비스
6.	6.기타 "회사"가 추가 개발하거나 다른 회사와의 제휴계약 등을 통해 "회원"에게 제공하는 일체의 서비스
...
③해외에 주소나 거소가 있는 '회원' 의 경우 '회사'와 '회원'간 발생한 분쟁에 관한 소송은 전항에도 불구하고 대한민국 서울중앙지방법원을 관할 법원으로 합니다.
							...
							<textarea rows="10" style="width:980px;">정보통신망법 규정에 따라 네이버에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
1. 수집하는 개인정보의 항목
...
<단체아이디 회원가입>
- 필수항목 : 단체아이디, 회사명, 대표자명, 대표 전화번호, 대표 이메일 주소, 단체주소, 관리자 아이디, 관리자 연락처, 관리자 부서/직위
...
나. 회원관리
회원제 서비스 제공, 개인식별, 네이버 이용약관 위반 회원에 대한 이용제한 조치, 서비스의 원활한 운영에 지장을 미치는 행위 및 서비스 부정이용 행위 제재, 가입의사 확인, 가입 및 가입횟수 제한, 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부 확인, 추후 법정 대리인 본인확인, 분쟁 조정을 위한 기록보존, 불만처리 등 민원처리, 고지사항 전달, 회원탈퇴의사의 확인
...
보존 기간 : 3개월
				...
				<table id="button">
					<tr height=100px;>
						<td align="center"><br>
						<input type="image" src="/resources/img/member/Agree_button.png" onclick="javaScript:location.href='/Join_step2'">&nbsp;<input type="image" src="/resources/img/member/Don't_agree_button.png" onclick="javaScript:location.href='/Login'"><br><br>
