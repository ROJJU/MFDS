...
nhn.husky.SE2M_TableCreator = jindo.$Class({
	...
	irToDbDOM : function(oTmpNode){
		 ...
		 *	(1) <TABLE>
		 *			<table border="1" cellpadding="0" cellspacing="0" style="border:1px dashed #c7c7c7; border-left:0; border-bottom:0;" attr_no_border_tbl="1" class="__se_tbl" width="400px">
		 *		-->	<table border="0" cellpadding="1" cellspacing="0" attr_no_border_tbl="1" class="__se_tbl" width="400px">
		 *	(2) <TD>
