...
<div style="width:900px; margin:0 auto; text-align:left; border:1px solid black; padding:30px;">
	<form id="boardWriteForm" method="post">
		  <div class="contentDiv">
		  	...
		  	<input type="hidden" value="32" name="contents_name">
		  	<input type="hidden" value="/NewForms.do?forms_seq=<%=request.getParameter("forms_seq")%>&list_seq=32" name="url" id="p_url">
		  	<input type="hidden" value="ck_form32" name="ck_form">
