...
<div style="width:900px; margin:0 auto; text-align:left; border:1px solid black; padding:30px;">
	<form id="boardWriteForm" method="post">
		  <div class="contentDiv">
		  	...
		  	<input type="hidden" value="contents30" name="contents_name">
		  	<input type="hidden" value="/NewForms.do?forms_seq=<%=request.getParameter("forms_seq")%>&list_seq=30" name="url">
		  	<input type="hidden" value="ck_form30" name="ck_form">
		    <textarea id="txtContent" name="contents" rows="30" style="width:100%; height:900px; color:#ffffff;">
		    	<c:choose>
		    		<c:when test="${forms.contents30!=null}">
		    			${forms.contents30}
		    		</c:when>
		    		<c:otherwise>
...
<td style="padding: 3px 4px 2px; color: rgb(61, 118, 171); width: 225px; height: 18px; background-color: rgb(255, 255, 255);" class=""><p style="text-align: center; ">&nbsp;</p></td><td style="padding: 3px 4px 2px; color: rgb(61, 118, 171); width: 522px; height: 18px; background-color: rgb(255, 255, 255);" class=""><p style="text-align: center;">&nbsp;</p></td></tr><tr><td style="padding: 3px 4px 2px; color: rgb(61, 118, 171); text-align: left; font-weight: normal; width: 93px; height: 18px; background-color: rgb(246, 248, 250);" class=""><p style="text-align: center;">2</p></td><td style="padding: 3px 4px 2px; color: rgb(61, 118, 171); width: 225px; height: 18px; background-color: rgb(255, 255, 255);" class=""><p style="text-align: center;">&nbsp;</p></td><td style="padding: 3px 4px 2px; color: rgb(61, 118, 171); width: 522px; height: 18px; background-color: rgb(255, 255, 255);" class=""><p style="text-align: center;">&nbsp;</p></td></tr><tr><td style="padding: 3px 4px 2px; color: rgb(61, 118, 171); text-align: left; font-weight: normal; width: 93px; height: 18px; background-color: rgb(246, 248, 250);" class=""><p style="text-align: center;">3</p></td><td style="padding: 3px 4px 2px; color: rgb(61, 118, 171); width: 225px; height: 18px; background-color: rgb(255, 255, 255);" class=""><p style="text-align: center;">&nbsp;</p></td><td style="padding: 3px 4px 2px; color: rgb(61, 118, 171); width: 522px; height: 18px; background-color: rgb(255, 255, 255);" class=""><p style="text-align: center;" align="center">&nbsp;</p></td>
</tr>
</tbody>
</table><p>&nbsp;</p>
		    		</c:otherwise>
