										...
										<tr>
											<td id="sub_side" rowspan="1" align="center">
												<table id="sub_side_table">
													<tr><td><img src="/resources/img/main/sub_icon.png" id="sub_icon">&nbsp;<b>Support</b></td></tr>
													<tr><td class="sub_side_bg" onclick="goUrl('/Support?page_seq=1');">User Guide</td></tr>
													<tr><td class="sub_side_bg" onclick="goUrl('/Support?page_seq=2');">FAQ</td></tr>
												</table>
											</td>
											<td id="sub_content" align="center">
												<div align="left" id="sub_title">User Guide</div>
												<table>
													<tr>
														<th>번호</th>
														<th>제목</th>
