...
<head>
	...
	<body>
		<div style=" background-color:#ffffff; text-align:center; height:34px; border-bottom:1px solid grey;">
			HWP 저장 : 
			<input type="image" src="/resources/img/btn/Part1.png" width="40px" onclick="HwpIt(<%=request.getParameter("forms_seq")%>, '2')">
			<input type="image" src="/resources/img/btn/Part2.png" width="40px" onclick="HwpIt(<%=request.getParameter("forms_seq")%>, '3')">
			<input type="image" src="/resources/img/btn/Part3.png" width="40px" onclick="HwpIt(<%=request.getParameter("forms_seq")%>, '4')">
		</div>
