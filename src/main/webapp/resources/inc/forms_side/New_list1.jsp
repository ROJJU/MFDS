       ...
       <h3><img src="/resources/img/forms/folder-horizontal.png">&nbsp;국제표준화기술문서</h3>
        <div class="panel loading">
        	<table>
        		...
        		<tr><td style="padding-left:10px; vertical-align:top;"><c:choose><c:when test="${forms.ck_form17==null}"><img src="/resources/img/forms/document.png"></c:when><c:otherwise><img src="/resources/img/forms/docu_check_icon.png"></c:otherwise></c:choose></td><td><a onclick="loadAndSave('<%=request.getParameter("forms_seq")%>','17','17')"><%if(list_seq.equals("17")){%><img src="/resources/img/forms/modify.gif"><%}%>&nbsp;제품사양</a></td></tr>
