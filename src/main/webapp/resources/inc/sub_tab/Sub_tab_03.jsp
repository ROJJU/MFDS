		...
		<tr>
			<td id="content_top_place">
				<div class="box"><!--tab menu-->
					<div id = "font">
						  <ul class="main_menu">
							   <li onclick = "goUrl('/Main.do')"><img src="/resources/img/common/star.gif">&nbsp;Welcome</li>
 							   <li class="active" onclick = "goUrl('/About.do')"><img src="/resources/img/common/star.gif">&nbsp;About STED</li>
