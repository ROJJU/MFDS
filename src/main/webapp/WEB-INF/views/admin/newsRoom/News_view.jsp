...
<table width="98%" border="0" align="left" cellpadding="0" cellspacing="0" >
	...
	<tr>
		<td>
			<form action="/AdminNews.do?page_seq=1&side_seq=0" method="post" name="notice">
				<div id ="serch">
					<select name="search">
	...
	<tr>
		...
		<table id="admintable" >
			...
			<c:forEach var="a" items="${list}">
				<tr onclick="goUrl('/AdminNews.do?page_seq=3&news_seq=${a.news_seq}&side_seq=0')" class="a">
					<td align="center">${a.news_seq}</td>
					<td align="left">
						${a.title}
			...
			<input type="image" src="/resources/img/main/input_button.png" onclick="goUrl('/AdminNews.do?page_seq=5&side_seq=0')" width="50px;"><br><br>
