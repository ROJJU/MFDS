...
<style type="text/css">
	.guideTitle{
	position:relative; background-color:#0064A8; padding:10px; top:0px; font-size:30px; color:#ffffff; font-weight:bolder;
	}
	.guideContents{
	padding:15px;
	}
...
<div class="guideContents">
	...
	<h3>※ 규격 용어 해설</h3>
	아래 기재한 규격은 대표적인 예로써 이외의 규격도 적용될 수 있습니다. 의료기기 관련 참고 할 수 있는 규격 목록자료는 의료기기안전국홈페이지(http://md.mfds.go.kr) 자료실에서 구할 수 있습니다.<br>
	<ul>
		<li type="none">- ISO(International Standardization Organization) : 국제 표준화기구에서 정한 규격 명칭</li>
		<li type="none">- ASTM(American Society of Testing Materials) : 미국 재료 시험 협회에서 정한 규격 명칭</li>
		<li type="none">- KS(Korean Standards) : 한국 공업 규격</li>
		<li type="none">- EN(European Norm) : 유럽 규격의 명칭</li>
		<li type="none">- DIN(Deusche Industrie Norm) : 독일 공업 규격의 명칭</li>
		<li type="none">- NF(Normes Francaises) : 프랑스 국가 규격</li>
	</ul>
</div>
...
<div class="guideContents">
	<div class="guideText">
		<ul>
			<li>제조방법은 “제조원의 제조방법에 따른다.”라고 작성할 수 있습니다. 다만, 다음 멸균의료기기의 제조방법의 경우 멸균방법, 멸균조건 및 포장방법을 추가적으로 기재하여 주십시오.</li>
		</ul>
	</div><br>
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	가. 제조방법<br>
	: 제조원의 제조방법에 따른다.<br>
...
<div class="guideContents">
	...
	<img src="/resources/img/forms/guide_help.png" width="100%">
	<h3>사용 전 준비사항</h3>
...
<div class="guideContents">
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide11.png" class="guideImg">
</div>
...
<div class="guideContents">
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide12.png" class="guideImg">
</div>
...
<div class="guideContents">
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide13.png" class="guideImg">
</div>
...
<div class="guideContents">
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide14.png" class="guideImg">
</div>
...
<div class="guideContents">
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide15_1.png" class="guideImg"><br>
	<img src="/resources/img/forms/guide/form_guide15_2.png" class="guideImg"><br>
	<img src="/resources/img/forms/guide/form_guide15_3.png" class="guideImg"><br>
	<img src="/resources/img/forms/guide/form_guide15_4.png" class="guideImg"><br>
	<img src="/resources/img/forms/guide/form_guide15_5.png" class="guideImg"><br>
	<img src="/resources/img/forms/guide/form_guide15_6.png" class="guideImg"><br>
	<img src="/resources/img/forms/guide/form_guide15_7.png" class="guideImg"><br>
	<img src="/resources/img/forms/guide/form_guide15_8.png" class="guideImg"><br>
</div>
...
<div class="guideContents">
	<img src="/resources/img/forms/guide/form_guide16.png" class="guideImg">
	<img src="/resources/img/forms/guide/form_guide16_2.png" class="guideImg"><br><br>
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide16_3.png" class="guideImg">
</div>
...
<div class="guideContents">
	<div class="guideText">
	<ul>
		<li> 위탁공정, 검사공정 및 멸균공정을 포함하는 원재료 구입부터 최종제품 출하까지의 전체 제조공정에 대한 흐름도를 기재하고, 각 공정에 대한 설명을 기재한다.</li>
		<li> 제품의 품질과 안전성에 큰 영향을 미치는 공정(포장, 코팅공정, 최종제품이 동물유래성분을 함유하거나 제조공정 중 동물 유래성분을 사용하는 경우에는 박테리아나 바이러스 등 병원성물질 제거 공정 등)은 별첨으로 상세 기재한다.</li>
		<li> 제조공정에 사용된 멸균방법, 별균규격 및 멸균조건(초기오염도 건사, 엔도톡신테스트, 멸균보증수준 등 포함)을 기재한다. 멸균 프로토콜 및 결과를 요약하여 기재하고 멸균 재검증이 진행되는 경우에는 이에 대한 사항(포장 및 멸균 곡ㅇ정에 대한 재검증 방식이나 이에 대한 결과 보고서가 해당)을 기재한다.</li>
	</ul>
	</div><br>
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide17_1.png" class="guideImg">
	<img src="/resources/img/forms/guide/form_guide17_2.png" class="guideImg">
	<img src="/resources/img/forms/guide/form_guide17_3.png" class="guideImg">
</div>
...
<div class="guideContents">
	<div class="guideText">
	<ul>
		<li>제조원 이외의 장소에서 제품설계 및 제조공정을 수행하는 경우 각 제조소의 제조국, 제조사명, 주소를 기재한다. 제조공정의 전부를 위탁하는경우 [의료기기 제조 및 품질관리기준] 또는 동등 이상의 규격에 따른 제조품질관리시스템 인증자료를 제출한다.</li>
	</ul>
	</div><br>
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide18_1.png" class="guideImg">
</div>
...
<div class="guideContents">
	<div class="guideText">
	<ul>
		<li>이 항목에서는 국제조화기구(Global Harmonization Task Force, 이하 GHTF라고 함)에 의해 제시된 '의료기기 안전성과 성능의 필수원칠(Essential Principles of Safety and Performance of Medical Devices, GHTF SG1)' 이른바 '필수원칙'에 대한 적합성 여부를 제시한다. 필수원칙은 의료기기가 준수해야 하는 품질, 안전성 및 유효성과 관련된 필수원칙을 규정한 것응로서 모든 의료기기는 이에 적합함을 증명해야 한다.</li>
		<li>필수원칙에 적합함을 나타내기 위해 사용된 규격의 제목, 번호 및 년도 등을 표4의 예시와 같이 목록응로 기재한다.</li>
	</ul>
	<center><img src="/resources/img/forms/guide/form_guide19.png" ></center>
	</div><br>
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide19_1.png" class="guideImg">
</div>
...
<div class="guideContents">
	...
	<br>
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide20.png" class="guideImg"><br>
	<img src="/resources/img/forms/guide/form_guide20_1.png" class="guideImg"><br>
</div>
...
<div class="guideContents">
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br>
	<img src="/resources/img/forms/guide/form_guide21.png" class="guideImg"><br>
	<img src="/resources/img/forms/guide/form_guide21_2.png" class="guideImg"><br>
</div>
...
<div class="guideContents">
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide22.png" class="guideImg">
</div>
...
<div class="guideContents">
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide23.png" class="guideImg">
</div>
...
<div class="guideContents">
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide24.png" class="guideImg">
</div>
...
<div class="guideContents">
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide25.png" class="guideImg">
</div>
...
<div class="guideContents">
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide26.png" class="guideImg">
</div>
...
<div class="guideContents">
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide27.png" class="guideImg">
</div>
<%}else if(num.equals("32")){%>
<div class="guideTitle">
	▶ 소프트웨어 검증 및 유효성 확인 자료 요약
</div>
<div class="guideContents">
	<div class="guideText">
		<ul>
			...
			<li type="none"><br><img src="/resources/img/forms/guide/form_guide28_2.png" ></li>
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide28.png" class="guideImg">
</div>
...
<div class="guideContents">
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide29.png" class="guideImg">
</div>
<%}else if(num.equals("34")){%>
<div class="guideTitle">
	▶ 동물유래 물질에 대한 안전성 자료 요약
</div>
<div class="guideContents">
	<div class="guideText">
		<ul>
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide30.png" class="guideImg">
</div>
...
<div class="guideContents">
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide31.png" class="guideImg">
</div>
<%}else if(num.equals("36")){%>
<div class="guideTitle">
	▶ 복합ㆍ조합된 의약품에 대한 정보 요약
</div>
<div class="guideContents">
	<div class="guideText">
		<ul>
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide32.png" class="guideImg">
</div>
...
<div class="guideContents">
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide33.png" class="guideImg">
</div>
...
<div class="guideContents">
	...
	<img src="/resources/img/forms/guide_help.png" width="100%"><br><br>
	<img src="/resources/img/forms/guide/form_guide34.png" class="guideImg">
</div>
